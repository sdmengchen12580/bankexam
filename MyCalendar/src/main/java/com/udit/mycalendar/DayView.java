...
public class DayView extends FrameLayout {
    ...
    private void init() {
        ...
        //初始化日 的颜色
        this.tvDay.setTextColor(getResources().getColor(R.color.back));
    ...
    private Drawable getSelectionDrawable() {
        if (_selectionDrawable == null) {
            _selectionDrawable = generateCircleDrawable(getResources().getColor(R.color.color_date_select));
        }
    ...
    private Drawable getIndicatorDrawable() {
        if (_indicatorDrawable == null) {
            _indicatorDrawable = generateCircleDrawable(getResources().getColor(R.color.color_date_text));
        }
