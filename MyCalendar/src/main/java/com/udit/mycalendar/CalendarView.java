...
import com.udit.mycalendar.Interface.CalendarCallback;
...
import com.udit.mycalendar.Util.WrapContentViewPager;
...
public class CalendarView extends WrapContentViewPager implements OnDateChangedListener, CalendarCallback {
    ...
    public CalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            calendarColor = a.getColor(R.styleable.CalendarView_mc_color, getResources().getColor(R.color.white));
