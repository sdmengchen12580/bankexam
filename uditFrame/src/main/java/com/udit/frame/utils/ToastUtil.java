...
public class ToastUtil
{
    ...
    public static void showMessage(final Context content, final String msg)
    {
        showMessage(content, msg, Toast.LENGTH_SHORT);
    }
    
   
    public static void showMessageLong(final Context content, final String msg)
    {
        showMessage(content, msg, Toast.LENGTH_LONG);
    }
