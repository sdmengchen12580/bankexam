...
{
    private final static String TAG = ImageFactory.class.getSimpleName();
    
    @SuppressLint("SdCardPath")
    private final static String SAVE_PATH = "/sdcard/Image/";
     ...
     * @return
     */
    public static Bitmap ratioBig(Bitmap bitmap, float bes)
    {
        Matrix matrix = new Matrix();
        matrix.postScale(bes,bes);//长和宽放大缩小的比例
        Bitmap resizeBmp =
     ...
     * @see [类、类#方法、类#成员]
     */
    public static Object[] BigToSmailAndSave(String save, int width, int height)
    {
        Bitmap bitmap = ratio(save, width, height);
        ...
        MyLogUtils.i(TAG, "拍照保存的路径：" + name);
        FileOutputStream b = null;
        File file = new File(SAVE_PATH);
        file.mkdirs();// 创建文件夹
        String fileName = SAVE_PATH + name;
        MyLogUtils.i(TAG, "路径：" + fileName);
        try
        {
        ...
        return new Object[]{bitmap,fileName};
    }
