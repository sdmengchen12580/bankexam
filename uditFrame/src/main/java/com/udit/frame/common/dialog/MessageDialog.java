package com.udit.frame.common.dialog;
...
public class MessageDialog extends Dialog
{
    ...
    public static class Builder
    {
        ...
        public MessageDialog create()
        {
            ...
            {
                ((TextView)layout.findViewById(R.id.okButton)).setText(positiveButtonText);
                if (positiveButtonClickListener != null)
                {
                    ((TextView)layout.findViewById(R.id.okButton)).setOnClickListener(new View.OnClickListener()
                    {
