...
public class DownFile_source
{
    ...
    public DownFile_source(Context context)
    {
        ...
        public void run()
        {
            try
            {
                ...
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
                {
                    ...
                    mSavePath = sdpath + "智慧警营下载文件";
                    MyLogUtils.e("DOWN", "SAVE:"+mSavePath);
                    URL url = new URL(mHashMap.get("url"));
                    String u = mHashMap.get("url");
                    String last_filetype =u.substring(u.lastIndexOf("."));
                    // 创建连接
                   ...
                   /*
                    ...
                    File apkFile = new File(mSavePath, mHashMap.get("name")+last_filetype);
                    mFile = apkFile;
