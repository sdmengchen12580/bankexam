...
//        mHeaderTimeViewTitle.setText("最后更新时间 " + getNetTimeA());
    ...
    public void setTime(String time) {
        if (mHeaderTimeViewTitle != null) {
            mHeaderTimeViewTitle.setText("最后更新时间 " + time);
        }
    }
