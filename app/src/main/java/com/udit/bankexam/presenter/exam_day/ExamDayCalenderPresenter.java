...
public class ExamDayCalenderPresenter extends ExamDayCalenderView.Presenter {
    ...
    public ExamDayCalenderPresenter(ExamDayCalenderView.View mView) {
        super(mView);
    }

    @Override
    public void getExamDayByTime(Context mContext,String uid, String begin, String end) {

        try {
            ProgressUtils.showProgressDlg("",mContext);
            HashMap<String,String> map_params = new HashMap();

            map_params.put(Constant.Params.ACTION, IHTTP.DOGETEXAMDAY);

            map_params.put(Constant.Params.UID,uid);
            map_params.put(Constant.Params.BEGIN,begin);
            map_params.put(Constant.Params.END,end);
    ...
    @Override
    public void getExamDay(Context mContext, String uid, String type) {
        HashMap<String,String> map_params = new HashMap<>();
