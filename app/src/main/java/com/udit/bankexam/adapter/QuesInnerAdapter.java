...
public class QuesInnerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<RowsBean> mList;
    private ViewGroup.LayoutParams vpViewG;

    public QuesInnerAdapter(Context paramContext, List<RowsBean> paramList, ClickCall clickCall) {
...
//        this.vpViewG = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Utils.dip2px(paramContext, 130F));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt) {
        return new HasViewHolder(LayoutInflater.from(this.context).inflate(R.layout.itemlayout_innter_ques, null));
    }
        ...
        if (paramViewHolder instanceof HasViewHolder) {
            ...
            ((HasViewHolder) paramViewHolder).container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (QuesInnerAdapter.this.clickCall != null) {
                        QuesInnerAdapter.this.clickCall.clickItem(bean.getId());
                    }
                }
            });
            //数据展示
