...
public class LoginOutPop {
  ...
  public LoginOutPop(Context paramContext) {
  ...
  public PopupWindow showPop(ClickCallback paramClickCallback) {
    ...
    Context context = (Context)this.weakReference.get();
    if (context != null) {
      this.popView = LayoutInflater.from(context).inflate(R.layout.pop_layout_login_out, null, false);
      ((RelativeLayout)this.popView.findViewById(R.id.rl_bg)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) { LoginOutPop.this.dismissPop(); }
          });
      ((TextView)this.popView.findViewById(R.id.tv_cancel)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) { LoginOutPop.this.dismissPop(); }
          });
      ((TextView)this.popView.findViewById(R.id.tv_true)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) {
              LoginOutPop.this.dismissPop();
              if (LoginOutPop.this.clickCallback != null)
                LoginOutPop.this.clickCallback.clickTrue();
            }
          });
