...
public interface RegisterView {
  public static abstract class Presenter extends BasePresenter<View> {
    public Presenter(RegisterView.View param1View) { super(param1View); }
...
/* Location:              C:\Users\Administrator\Desktop\classes-dex2jar.jar!\co\\udit\bankexam\vie\\user\RegisterView.class
