...
public class HomeXyExitPop {
    ...
    public HomeXyExitPop(Context baseActivity) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity).inflate(R.layout.pop_xy_home_exit, null, false);
            ...
            tv_agree.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (HomeXyExitPop.this.clickCallback != null) {
                        HomeXyExitPop.this.clickCallback.clickTrue();
                        dismissPop();
                    }
                }
            });
            ...
            tv_not_agree.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (HomeXyExitPop.this.clickCallback != null) {
                        HomeXyExitPop.this.clickCallback.clickFalse();
                        dismissPop();
                    }
                }
            });
