...
public class ZhaoPinInfo {
  ...
  public static class DataBean {
    ...
    public static class ResponseBean {
      ...
      private String zhaopinsMoreUrl;

      public String getZhaopinsMoreUrl() {
        return zhaopinsMoreUrl;
      }

      public void setZhaopinsMoreUrl(String zhaopinsMoreUrl) {
        this.zhaopinsMoreUrl = zhaopinsMoreUrl;
      }
