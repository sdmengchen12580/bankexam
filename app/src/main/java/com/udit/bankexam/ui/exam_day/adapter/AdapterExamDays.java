...
public class AdapterExamDays extends BaseAdapter {

    private List<ExamInfoBean> list;

    private Context mContext;

    public AdapterExamDays(List<ExamInfoBean> list, Context mContext) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ll_zb_info.setVisibility(View.GONE);
        holder.ll_examinfo_goumairenshu.setVisibility(View.GONE);
      ...
      /*
        ...
        holder.textview_examinfo_tinshou.setText(day + "天");
        return convertView;
    }

    private class Holder {
        LinearLayout ll_examinfo_goumairenshu;

        LinearLayout ll_examinfo_price;

        LinearLayout ll_zb_info;
