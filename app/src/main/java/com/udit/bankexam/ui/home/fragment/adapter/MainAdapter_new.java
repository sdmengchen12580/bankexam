...
public class MainAdapter_new extends BaseAdapter {
    ...
    public MainAdapter_new(List<ExamNodeBean> mlist_bean, Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ExamNodeHolder holder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_exam_node_new, null);
            holder = new ExamNodeHolder();
            ViewUtils.initHolderView(holder, convertView, R.id.class);
            convertView.setTag(holder);
        } else {
            holder = (ExamNodeHolder) convertView.getTag();
        }
