...
public class NoteBookAdapter extends BaseAdapter {
    ...
    public NoteBookAdapter(List<ExamBean> mlist, Context mContext, ExamListener examListener) {
        this.mlist = mlist;
        this.mContext = mContext;
        this.examListener = examListener;
        this.vpViewG = new RelativeLayout.LayoutParams(-1, Utils.dip2px(mContext, 115.0F));
    }
