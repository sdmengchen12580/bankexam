		...
		setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				case speed_05:
					...
					ToastUtil.showMessage(getContext(),"当前为1倍速");
				...
				case speed_1:
					...
					ToastUtil.showMessage(getContext(),"当前为1.2倍速");
				...
				case speed_12:
					...
					ToastUtil.showMessage(getContext(),"当前为1.5倍速");
				...
				case speed_15:
					...
					ToastUtil.showMessage(getContext(),"当前为2倍速");
				...
				case speed_2:
					...
					ToastUtil.showMessage(getContext(),"当前为0.5倍速");
