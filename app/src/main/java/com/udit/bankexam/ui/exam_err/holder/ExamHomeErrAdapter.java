...
public class ExamHomeErrAdapter extends BaseAdapter {
    ...
    public ExamHomeErrAdapter(List<ExamNodeBean> mlist_bean, Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_exam_node_home_err, null);
