...
public class ExamCollectionAdapter extends BaseAdapter {
    ...
    public ExamCollectionAdapter(List<ExamBean> mlist, Context mContext,ExamListener examListener) {
        this.mlist = mlist;
        this.mContext = mContext;
        this.examListener = examListener;
        this.vpViewG = new ViewGroup.LayoutParams(-1, Utils.dip2px(mContext, 115.0F));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // holder.text_sreach_exam_title.setText("("+qtype+")   "+ Html.fromHtml(title));
      //  holder.text_sreach_exam_title.setText(Html.fromHtml(title,new URLImageGetter(title,mContext,holder.text_sreach_exam_title, MyApplication.user_options),null));
